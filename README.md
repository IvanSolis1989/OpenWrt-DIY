...
|    序号   |     设备     |   编译状态及下载链接 |   插件配置   | 备注说明   |
| :-----------------: | :-------------: |:-----------------: | :-----------------: |  :-----------------: | 
|    序号   |     设备平台     |   X86设备编译状态及下载链接 |   插件配置   | 备注说明   |
...
|    序号   |     设备平台     |   ARM设备编译状态及下载链接 |   插件配置   | 备注说明   |
...
|    序号   |     设备平台     |   高通平台设备编译状态及下载链接 |   插件配置   | 备注说明   |
...
|    序号   |     设备平台     |   MIPS设备编译状态及下载链接 |   插件配置   | 备注说明   |
